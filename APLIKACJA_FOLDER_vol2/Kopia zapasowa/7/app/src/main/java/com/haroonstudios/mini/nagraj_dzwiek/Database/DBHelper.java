package com.haroonstudios.mini.nagraj_dzwiek.Database;
...
public class DBHelper extends SQLiteOpenHelper
{
    ...
    public boolean addRecording(RecordingItem recordingItem)
    {
        try
        {
            ...
            contentValues.put(COLUMN_NAME,recordingItem.getMane());
            contentValues.put(COLUMN_PATH,recordingItem.getPath());
            contentValues.put(COLUMN_LENGTH,recordingItem.getLenihgt());
